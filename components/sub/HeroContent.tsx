                            ...
                            <InView triggerOnce={false}>
                                {({ inView, ref }) => (
                                    ...
                                    >
                                        ...
                                        <h1 className="Welcome-text text-[13px]">Java Developer</h1>
                                    </motion.div>
                                )}
                            </InView>
                            <InView triggerOnce={false}>
                        ...
                        <InView triggerOnce={false}>
                            {({ inView, ref }) => (
                                <motion.div
                                    ...
                                    className="max-w-[650px] text-gray-400 text-base md:text-lg leading-8 my-5 z-30"
                                >
                                    <p>Dedicated to creating intuitive, reliable, and user-focused digital experiences. Constantly exploring new ideas and embracing every opportunity to grow.</p>
                                </motion.div>
                            )}
                        </InView>
                        <InView triggerOnce={false}>
